...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "ConversiobEutoToDh", targetNamespace = "http://ws/", className = "proxy.ConversiobEutoToDh")
    @ResponseWrapper(localName = "ConversiobEutoToDhResponse", targetNamespace = "http://ws/", className = "proxy.ConversiobEutoToDhResponse")
    @Action(input = "http://ws/BanqueService/ConversiobEutoToDhRequest", output = "http://ws/BanqueService/ConversiobEutoToDhResponse")
    public double conversiobEutoToDh(
